...
export const caseStudy = {
  ...
  testimonial: {
    ...
    content:
      'ErgonITech did an amazing job building out our core blockchain infrastructure and I’m sure once PlaceboCoin rallies they’ll be able to finish the project.',
  },
}
...
>
  ErgonITech did an amazing job building out our core blockchain infrastructure and
